...
$stmt = $pdo->prepare("SELECT * FROM mil_proto2_itemTable WHERE id=$id");
...
<div class="container container-m">
  ...
  <form method="post" action="update.php" enctype="multipart/form-data">
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-4 mb-3">
        ...
        <select name="cond" id="cond" class="form-select" required>
          <option value="<?=$row['cond'];?>" selected hidden><?=$row['cond'];?></option>
    ...
    <div class="mb-3">
      ...
      <textarea name="memo" class="form-control" placeholder="メモを入力"><?=$row['memo'];?></textarea>
    </div>
...
<!-- Main[End] -->
<div class="container">
  <a href="display.php" class="btn btn-secondary w-100 mt-1">登録アイテム一覧に戻る</a>
</div>
